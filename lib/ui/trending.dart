          ...
          Row(
            ...
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.trending_up_outlined, color: Colors.white),
              ...
              const Padding(
                  padding: EdgeInsets.only(top: 38.0, right: 18),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 151, 99, 204)
                                    .withOpacity(0.9),
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Apex Legends sẽ sớm được phát hành trên Android và Apple, theo các nguồn tin không chính thức.',
                      style: GoogleFonts.quicksand(
                        color: Colors.grey[300],
                        fontSize: 13,
                        letterSpacing: 1,
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(
                        top: 8.0, left: 8, right: 8, bottom: 17),
                    child: Text(
                      'PUBG sẽ sớm được phát hành trên Android và Apple, theo các nguồn tin không chính thức',
                      style: GoogleFonts.quicksand(
                        color: Colors.grey[300],
                        fontSize: 13,
                        letterSpacing: 1,
                      ...
                      children: [
                        Container(
                          ...
                          child: Stack(
                            children: <Widget>[
                              Container(
                                  color: const Color.fromARGB(255, 39, 33, 75),
                                  height: 100,
                                  width: MediaQuery.of(context).size.width,
                                  child: ClipRRect(
                                    borderRadius: const BorderRadius.only(
